...
#     Toluene
    ...
    calc = pcsaft_p(x, m, s, e, t, rho, e_assoc=eAB, vol_a=volAB)
    print('----- Pressure at {} K -----'.format(t))
    print('    Reference:', ref, 'Pa')
    print('    PC-SAFT:', calc, 'Pa')
    print('    Relative deviation:', (calc-ref)/ref*100, '%')
    ...
    calc = pcsaft_p(x, m, s, e, t, rho, dipm=dpm, dip_num=dip_num)
    print('----- Pressure at {} K -----'.format(t))
    print('    Reference:', ref, 'Pa')
    print('    PC-SAFT:', calc, 'Pa')
    print('    Relative deviation:', (calc-ref)/ref*100, '%')
    ...
    calc = pcsaft_p(x, m, s, e, t, rho, k_ij=k_ij, e_assoc=eAB, vol_a=volAB)
    print('----- Pressure at {} K -----'.format(t))
    print('    Reference:', ref, 'Pa')
    print('    PC-SAFT:', calc, 'Pa')
    print('    Relative deviation:', (calc-ref)/ref*100, '%')
    ...
    calc = pcsaft_p(x, m, s, e, t, rho, k_ij=k_ij, e_assoc=eAB, vol_a=volAB, z=z, dielc=dielc)
    print('----- Pressure at {} K -----'.format(t))
    print('    Reference:', ref, 'Pa')
    print('    PC-SAFT:', calc, 'Pa')
    print('    Relative deviation:', (calc-ref)/ref*100, '%')
